Run it on Casperbox
/*==============================================================================*/
/* Casper generated Fri Oct 07 2016 23:31:56 GMT-0400 (Eastern Daylight Time) */
/*==============================================================================*/
...
casper.test.begin('Resurrectio test', function(test) {
   ...
   casper.then(function() {
       this.mouse.down(948, 167);
       this.mouse.move(749, 165);
       this.mouse.up(749, 165);
   });
   ...
   casper.then(function() {
       this.mouse.down(808, 288);
       this.mouse.move(805, 288);
       this.mouse.up(805, 288);
   });
   ...
   casper.then(function() {
       this.mouse.click(1200, 316);
   });
   casper.then(function() {
       this.mouse.down(1919, 360);
       this.mouse.move(1897, 627);
       this.mouse.up(1897, 627);
   });
   casper.waitForSelector("form#postingForm button[type=submit][value='Continue']",
       function success() {
           test.assertExists("form#postingForm button[type=submit][value='Continue']");
   ...
   /* submit form */
   casper.then(function() {
       this.mouse.down(584, 233);
       this.mouse.move(584, 232);
       this.mouse.up(584, 232);
   });
